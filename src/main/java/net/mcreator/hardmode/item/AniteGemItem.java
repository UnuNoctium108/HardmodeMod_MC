...
public class AniteGemItem extends HardmodeElements.ModElement {
	@ObjectHolder("hardmode:anitegem")
	public static final Item block = null;
	public AniteGemItem(HardmodeElements instance) {
		super(instance, 19);
	}
