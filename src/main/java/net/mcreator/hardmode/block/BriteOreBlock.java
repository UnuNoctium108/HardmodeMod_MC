...
import net.mcreator.hardmode.procedures.BriteGemItemInInventoryTickProcedure;
import net.mcreator.hardmode.item.BriteGemItem;
...
public class BriteOreBlock extends HardmodeElements.ModElement {
	@ObjectHolder("hardmode:briteore")
	public static final Block block = null;
	public BriteOreBlock(HardmodeElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BriteGemItem.block, (int) (1)));
		}
