...
public class EmeliteGemItem extends HardmodeElements.ModElement {
	@ObjectHolder("hardmode:emelitegem")
	public static final Item block = null;
	public EmeliteGemItem(HardmodeElements instance) {
		super(instance, 3);
	}
