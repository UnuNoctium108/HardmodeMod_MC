...
public class AniteAxeItem extends HardmodeElements.ModElement {
	@ObjectHolder("hardmode:aniteaxe")
	public static final Item block = null;
	public AniteAxeItem(HardmodeElements instance) {
		super(instance, 22);
	}
