...
public class AnitePickaxeItem extends HardmodeElements.ModElement {
	@ObjectHolder("hardmode:anitepickaxe")
	public static final Item block = null;
	public AnitePickaxeItem(HardmodeElements instance) {
		super(instance, 21);
	}
